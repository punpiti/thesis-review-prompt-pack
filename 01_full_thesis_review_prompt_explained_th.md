...
ก่อนแก้ภาษา ควรให้ AI ทำ stress tests 5 ด่าน: ปัญหายังมีจริงและสำคัญหรือไม่, งานมีเงื่อนไขที่ fail ได้หรือไม่, gate ที่ต้องผ่านก่อน optimization ผ่านครบหรือไม่, metric วัด construct ที่ claim จริงหรือไม่, และ solution สร้างปัญหาใหม่ที่ยอมรับไม่ได้หรือไม่
...
- ตรวจ problem survival: ปัญหายังมีอยู่จริง สำคัญ ยัง unresolved และยังไม่ถูกแก้ได้พอแล้วด้วยวิธีที่ง่ายกว่า ปลอดภัยกว่า หรือเป็นมาตรฐานกว่า
...
- ตรวจ genuine failure: มีผลแบบใดที่จะทำให้ตอบว่า method ไม่ได้แก้ปัญหาหรือ claim ไม่ถูก support หรือไม่
...
- ตรวจ measurement ceiling: claim ต้องไม่แรงกว่า construct, proxy/indicator, instrument/ground truth, data procedure และ analysis ที่รองรับจริง
...
- ตรวจ mandatory gates เช่น correctness, safety, security, ethics/legal compliance, capacity หรือ maximum error ก่อนเปรียบเทียบ optimization metrics
- ตรวจ no-new-problem guardrail ว่า solution ไม่สร้างภาระใหม่ที่ยอมรับไม่ได้ด้าน privacy, security, cost, fairness, accessibility, maintenance, energy หรือ stakeholder burden
...
- หัวข้อใดไม่ควรทำซ้ำ เว้นแต่ผู้ใช้สั่งว่า "ประเมินใหม่ทั้งหมด"
